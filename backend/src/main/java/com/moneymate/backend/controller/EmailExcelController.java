...
"income_details.xlsx");
    ...
    // 4. Prepare the email content
    String subject = "Your Expense Details - moneyMate";
    String body = "Hello " + profile.getFullName() + " ,<br>Please find attached your requested expense tracking details generated by moneyMate.<br>Keep up the great work tracking your finances!<br><br>Best regards,<br>The moneyMate Team";
