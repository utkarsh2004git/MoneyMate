...
import TransactionalInfoCard from "../components/TransactionalInfoCard";
...
const Filter = () => {
  ...
  const handleSearch = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axiosConfig.post(API_ENDPOINTS.APPLY_FILTERS, {
        type,
        startDate,
        endDate,
        keyword,
      ...
      console.error("Failed to fetch the transaction: ", error);
      toast.error(
            ...
            <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
              ...
              <div className="sm:col-span-1 md:col-span-2 flex items-end">
                ...
                <button
                  ...
                  className="ml-2 mb-1 p-2 duration-200 bg-blue-500 hover:bg-blue-800 text-white rounded flex items-center justify-center cursor-pointer"
                >
                  <Search size={20} />
                </button>
              </div>
