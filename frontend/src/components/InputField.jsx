...
const InputField = ({ 
  ...
  // Check if this specific input is a password field
  ...
  return (
    <div>
      ...
      <div className="relative">
        <input
          id={id}
          // Dynamically toggle the type between password and text
          type={isPassword ? (showPassword ? "text" : "password") : type}
          value={value}
          onChange={onChange}
          placeholder={placeholder}
          required={required}
          // Add padding to the right (pr-10) only if it's a password field to make room for the icon
        ...
        {/* Render the eye button ONLY if the type is "password" */}
        {isPassword && (
          <button
            type="button"
